...
<Project Type="Project" LVVersion="16008000">
	<Item Name="我的电脑" Type="My Computer">
		...
		<Property Name="server.tcp.acl" Type="Str"></Property>
		...
		<Item Name="UI" Type="Folder">
			<Item Name="控件" Type="Folder">
				...
				<Item Name="周期设置菜单" Type="Folder">
					<Item Name="周期设置菜单.xctl" Type="XControl" URL="../UI/控件/周期设置菜单/周期设置菜单.xctl"/>
				</Item>
				...
				<Item Name="切换按钮.ctl" Type="VI" URL="../UI/控件/切换按钮.ctl"/>
			</Item>
		...
		<Item Name="系统设置" Type="Folder">
			...
			<Item Name="首页设置全局变量.vi" Type="VI" URL="../系统/首页设置全局变量.vi"/>
		...
		<Item Name="任务处理" Type="Folder">
			<Item Name="Monitoring task.vi" Type="VI" URL="../任务处理/Monitoring task.vi"/>
			<Item Name="测试流程.vi" Type="VI" URL="../任务处理/测试流程.vi"/>
		</Item>
		<Item Name="动力环境" Type="Folder">
			<Item Name="动力环境.lvlib" Type="Library" URL="../API/动力环境/动力环境.lvlib"/>
			<Item Name="GPS.lvlib" Type="Library" URL="../API/动力环境/GPS/GPS.lvlib"/>
			<Item Name="THM-V6数字型温湿度.lvlib" Type="Library" URL="../API/动力环境/THM-V6数字型温湿度/THM-V6数字型温湿度.lvlib"/>
			<Item Name="DAM0200-Relay.lvlib" Type="Library" URL="../API/动力环境/DAM0200-Relay/DAM0200-Relay.lvlib"/>
			<Item Name="EPEVER-MPPT.lvlib" Type="Library" URL="../API/动力环境/EPEVER-MPPT/EPEVER-MPPT.lvlib"/>
		</Item>
		...
		<Item Name="依赖关系" Type="Dependencies">
			...
			<Item Name="insert values.vi" Type="VI" URL="../API/database/Interface/insert values.vi"/>
			<Item Name="Access Lib.lvlib" Type="Library" URL="../API/database/Access/Access Lib.lvlib"/>
			<Item Name="SQLite Lib.lvlib" Type="Library" URL="../API/database/SQLite/SQLite Lib.lvlib"/>
			...
			<Item Name="集成多参数单参数字段定义.ctl" Type="VI" URL="../API/database/control/集成多参数单参数字段定义.ctl"/>
			<Item Name="集成多参数全参数数据插入.vi" Type="VI" URL="../API/database/Interface/集成多参数全参数数据插入.vi"/>
			<Item Name="集成多参数单参数数据插入.vi" Type="VI" URL="../API/database/Interface/集成多参数单参数数据插入.vi"/>
			<Item Name="原位多参数全参数字段定义.ctl" Type="VI" URL="../API/database/control/原位多参数全参数字段定义.ctl"/>
			<Item Name="原位多参数全参数数据插入.vi" Type="VI" URL="../API/database/Interface/原位多参数全参数数据插入.vi"/>
		...
		<Item Name="程序生成规范" Type="Build">
			<Item Name="水质自动监测系统" Type="EXE">
				...
				<Property Name="Bld_buildSpecName" Type="Str">水质自动监测系统</Property>
				<Property Name="Bld_defaultLanguage" Type="Str">ChineseS</Property>
				<Property Name="Bld_excludeInlineSubVIs" Type="Bool">true</Property>
				<Property Name="Bld_excludeLibraryItems" Type="Bool">true</Property>
				<Property Name="Bld_excludePolymorphicVIs" Type="Bool">true</Property>
				<Property Name="Bld_localDestDir" Type="Path">/C/LabVIEW Project/builds/NI_AB_PROJECTNAME/水质自动监测系统</Property>
				<Property Name="Bld_modifyLibraryFile" Type="Bool">true</Property>
				<Property Name="Bld_previewCacheID" Type="Str">{D2FBB827-1878-4DE1-A43E-88C2716D5DCE}</Property>
				<Property Name="Bld_version.build" Type="Int">32</Property>
				<Property Name="Bld_version.major" Type="Int">1</Property>
				<Property Name="Destination[0].destName" Type="Str">水质自动监测系统.exe</Property>
				<Property Name="Destination[0].path" Type="Path">/C/LabVIEW Project/builds/NI_AB_PROJECTNAME/水质自动监测系统/水质自动监测系统.exe</Property>
				<Property Name="Destination[0].path.type" Type="Str">&lt;none&gt;</Property>
				<Property Name="Destination[0].preserveHierarchy" Type="Bool">true</Property>
				<Property Name="Destination[0].type" Type="Str">App</Property>
				<Property Name="Destination[1].destName" Type="Str">支持目录</Property>
				<Property Name="Destination[1].path" Type="Path">/C/LabVIEW Project/builds/NI_AB_PROJECTNAME/水质自动监测系统/data</Property>
				<Property Name="Destination[1].path.type" Type="Str">&lt;none&gt;</Property>
				<Property Name="DestinationCount" Type="Int">2</Property>
				<Property Name="Exe_iconItemID" Type="Ref">/我的电脑/data/fb.ico</Property>
				<Property Name="Source[0].itemID" Type="Str">{68CDDA5C-09FD-4CB1-BD8C-4C014BADFFDE}</Property>
				...
				<Property Name="Source[3].itemID" Type="Ref">/我的电脑/其他.lvlib</Property>
				...
				<Property Name="Source[5].itemID" Type="Ref">/我的电脑/UI/VIS/首页.vi</Property>
				...
				<Property Name="Source[8].itemID" Type="Ref">/我的电脑/斯坦道原位多参数.lvlib</Property>
				<Property Name="Source[8].Library.allowMissingMembers" Type="Bool">true</Property>
				<Property Name="Source[8].type" Type="Str">Library</Property>
				<Property Name="Source[9].destinationIndex" Type="Int">0</Property>
				<Property Name="Source[9].itemID" Type="Ref">/我的电脑/data/remote.ini</Property>
				<Property Name="Source[9].sourceInclusion" Type="Str">Include</Property>
				<Property Name="SourceCount" Type="Int">14</Property>
				<Property Name="TgtF_fileDescription" Type="Str">水质自动监测系统</Property>
				<Property Name="TgtF_legalCopyright" Type="Str">版权 2022</Property>
				<Property Name="TgtF_productName" Type="Str">水质自动监测系统</Property>
				<Property Name="TgtF_targetfileGUID" Type="Str">{F20B5619-0396-433C-B501-F0A70FA24780}</Property>
				<Property Name="TgtF_targetfileName" Type="Str">水质自动监测系统.exe</Property>
			</Item>
		</Item>
	</Item>
</Project>
