...
<Library LVVersion="16008000">
	...
	<Item Name="操作者消息" Type="Folder">
		<Item Name="close消息.lvclass" Type="LVClass" URL="../THM-V6数字型温湿度 Messages/close消息/close消息.lvclass"/>
		<Item Name="open消息.lvclass" Type="LVClass" URL="../THM-V6数字型温湿度 Messages/open消息/open消息.lvclass"/>
		<Item Name="READ Data消息.lvclass" Type="LVClass" URL="../THM-V6数字型温湿度 Messages/READ Data消息/READ Data消息.lvclass"/>
	</Item>
	<Item Name="调用者抽象消息" Type="Folder"/>
	<Item Name="THM-V6数字型温湿度.lvclass" Type="LVClass" URL="../THM-V6数字型温湿度/THM-V6数字型温湿度.lvclass"/>
</Library>
