...
<Library LVVersion="16008000">
	...
	<Item Name="常规五参数" Type="Folder">
		...
		<Item Name="通讯" Type="Folder">
			...
			<Item Name="STD校准信息读取.vi" Type="VI" URL="../常规五参数/STD校准信息读取.vi"/>
			<Item Name="STD校准信息写入.vi" Type="VI" URL="../常规五参数/STD校准信息写入.vi"/>
			<Item Name="温度校准读取.vi" Type="VI" URL="../常规五参数/温度校准读取.vi"/>
			<Item Name="温度校准写入.vi" Type="VI" URL="../常规五参数/温度校准写入.vi"/>
			<Item Name="读取系列号.vi" Type="VI" URL="../常规五参数/读取系列号.vi"/>
		</Item>
